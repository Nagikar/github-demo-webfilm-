...
return [
    "development" => [
        ...
        "database_user" => "root",
        "database_pass" => "",
        "dabatase_name" => "phim_db",
        "database_auto_init" => true,

        "session_name" => "session",
        "session_encrypt_method" => "aes-256-cbc",
        "session_iv" => "NIlyOE1AWv7oAbfd", // Generated in the install process
        "session_key" => "bXFHvcuiE4KWHqnf558OAQHkIH08eKu8", // Generated in the install process
